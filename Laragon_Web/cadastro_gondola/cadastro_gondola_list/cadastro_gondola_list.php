  ...
  include "../../menu/menu.php";
    ...
    if (!array_key_exists('msg_alert', $_GET)) {
      ...
      if ($_GET['msg_alert'] == "success_form"){
        $_GET['sucess'] = "true";
        $_GET['msg'] = "Gôndola inserida/adicionada com sucesso!";
      }
      else
      if ($_GET['msg_alert'] == "error_form") {
        $_GET['sucess'] = "false";
        $_GET['msg'] = "Erro ao inserir/cadastrar gôndola!";
      }
      else
      if ($_GET['msg_alert'] == "success_excluir") {
        $_GET['sucess'] = "true";
        $_GET['msg'] = "Gondola excluída com sucesso!";
      }
      else
      if ($_GET['msg_alert'] == "error_excluir") {
        $_GET['sucess'] = "false";
        $_GET['msg'] = "Erro ao excluir gôndola!";
      }
    }
    /*------------------------------*/
  ...
  if ($_POST) {
    ...
    if ( array_key_exists('delete', $_POST) && $_POST['delete'] != "") {
      ...
      if($response == "201" || $response == "200") {
        echo '<script>window.location.href = "' . $url_raiz . $url_gondola_list .'?msg_alert=success_excluir";</script>';
      } else {
        echo '<script>window.location.href = "' . $url_raiz . $url_gondola_list .'?msg_alert=error_excluir";</script>';
      }
    }
    /*------------------------------*/
  }
    ...
    <div class="buttons" style="display: flex;">
      ...
      <?php if ($_GET['sucess'] == "true") : ?>
        <div class="success">
            ...
            <div class="success__close">
              <a href="http://localhost/cadastro_gondola/cadastro_gondola_list/cadastro_gondola_list.php?sucess=ok">
      ...
      <?php if ($_GET['sucess'] == "false") : ?>
        <div class="error">
          ...
          <div class="error__title">Erro ao inserir/cadastrar gôndola!</div>
          <div class="error__close">
            <a href="http://localhost/cadastro_gondola/cadastro_gondola_list/cadastro_gondola_list.php?sucess=ok">
              <svg height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                <path d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#393a37"></path>
